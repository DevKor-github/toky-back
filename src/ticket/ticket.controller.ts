...
export class TicketController {
  ...
  @ApiOperation({ summary: '본인 응모권 갯수 조회' })
  ...
  @Get('/history')
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({ summary: '응모권 획득 및 사용 내역 조회' })
  ...
  @Get('/draw')
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({ summary: '경품 응모 참여인원 조회' })
